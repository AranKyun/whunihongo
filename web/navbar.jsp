...
<script language="javascript" type="text/javascript">
  ...
  function loginCheck() {
    ...
    var type = getCookie(cookieName_usertype);
    var isVisitor = document.getElementById("passerby").value;
    alert(isVisitor);
    if (isVisitor=="true"){
    ...
    if (document.getElementById('passerby').value == "true") {
           ...
           <%--如果有用户登入--%>
            <c:if test="${u1!=null}">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                  <A href="login!logout.action"> <font size="+1" face='Nico'>退出</font></A>
                </li>
              </ul>
            </c:if>
          </div>
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" role="form" style="font-size:0.8em;color:#333;margin-top:10px;"
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label" style="font-weight:600;font-size: 1.4em;margin-right: -20px;color: #595757;">
              账  &nbsp 号
            </label>
            <div class="col-sm-7">
              <input type="text" name="lusername" id="lusernameid" class="form-control" placeholder="QQ号或注册账号">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label" style="font-weight:600;font-size: 1.4em;margin-right: -20px;color: #595757;">
            ...
            <div class="col-sm-7 ">
              <input type="password" name="lpassword" id="lpasswordid" class="form-control" placeholder="长度大于等于6">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label" for="input2" style="font-weight:600;font-size: 1.4em;margin-right: -20px;color: #595757;">
              验证码
            </label>
            <div class="col-sm-5">
            ...
            <div class="col-md-2">
              <input type="text" id="lcheckCode" class="form-control" style="font-size:1.4em" readonly="readonly" oncontextmenu="return false" onclick="lcreateCode()" >
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-3 col-sm-offset-3">
              <div class="checkbox">
                <label  style="font-size:0.8em">
                  <input name="passerby" type="checkbox" id="passerby" value="passerby"/>
                  游客登录
                </label>
              </div>
            </div>
          ...
          <div class="form-group">
            <div class="col-sm-offset-3 col-sm-6">
              <button type="submit" class="btn btn-success" style="font-size:1.8em; width:100%;;font-weight:600;margin-top:15px;">
                登   录
              </button>
            ...
            <%
              ...
              String dialog_url = "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=" + app_id + "&redirect_uri=" + URLEncoder.encode(my_url) + "&state=" + code;
